                ...
                <div className="relative px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-6 prose prose-indigo prose-lg text-neutral-text-muted mx-auto">
                        ...
                        <ul>
                            ...
                            <li>Download and use our mobile application (Furlab), or any other application of ours that links to this Privacy Notice</li>
                            <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                        </ul>
                        <p>
                            <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:contact@furlab.cc">contact@furlab.cc</a>.
                        </p>
                        ...
                        <p>
                            <strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by visiting <a href="mailto:contact@furlab.cc">contact@furlab.cc</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
                        </p>
                        ...
                        <ul>
                            ...
                            <li>usernames</li>
                            <li>passwords</li>
                            <li>pet information (such as name, breed, age, medical history, or behavior)</li>
                            <li>pet-related identifiers such as insurance numbers, microchip ids, or registration details</li>
                        ...
                        <p>
                            <strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by Apple Inc. You may find their privacy notice link(s) here: <a href="https://www.apple.com/legal/privacy/en-ww/" target="_blank" rel="noopener noreferrer">https://www.apple.com/legal/privacy/en-ww/</a>.
                        </p>
                        <p>
                        ...
                        <p>
                            <strong><em>If you are located in Canada, this section applies to you.</em></strong>
                        </p>
                        <p>
                        ...
                        <p>
                            We provide the AI Products through third-party service providers ("AI Service Providers"), including Bytedance. As outlined in this Privacy Notice, your input, output, and personal information will be shared with and processed by these AI Service Providers to enable your use of our AI Products for purposes outlined in "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?" You must not use the AI Products in any way that violates the terms or policies of any AI Service Provider.
                        </p>
                        <p>
                        ...
                        <p>
                            We do not knowingly collect, solicit data from, or market to children under 18 years of age or the equivalent age as specified by law in your jurisdiction, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or the equivalent age as specified by law in your jurisdiction or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age or the equivalent age as specified by law in your jurisdiction has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18 or the equivalent age as specified by law in your jurisdiction, please contact us at <a href="mailto:contact@furlab.cc">contact@furlab.cc</a>.
                        </p>

                        <h2>12. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                        <p>
                            <strong><em>In Short:</em></strong> <em>Depending on your state of residence in the US or in some regions, such as Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time, depending on your country, province, or state of residence.</em>
                        </p>
                        <p>
                        ...
                        <ul>
                            <li><strong>A. Identifiers</strong> - Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name - YES</li>
                            <li><strong>B. Personal information as defined in the California Customer Records statute</strong> - Name, contact information, education, employment, employment history, and financial information - YES</li>
                            <li><strong>C. Protected classification characteristics under state or federal law</strong> - Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data - NO</li>
                            <li><strong>D. Commercial information</strong> - Transaction information, purchase history, financial details, and payment information - NO</li>
                            <li><strong>E. Biometric information</strong> - Fingerprints and voiceprints - NO</li>
                            <li><strong>F. Internet or other similar network activity</strong> - Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements - NO</li>
                            <li><strong>G. Geolocation data</strong> - Device location - NO</li>
                            <li><strong>H. Audio, electronic, sensory, or similar information</strong> - Images and audio, video or call recordings created in connection with our business activities - NO</li>
                            <li><strong>I. Professional or employment-related information</strong> - Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us - NO</li>
                            <li><strong>J. Education Information</strong> - Student records and directory information - NO</li>
                            <li><strong>K. Inferences drawn from collected personal information</strong> - Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual's preferences and characteristics - NO</li>
                            <li><strong>L. Sensitive personal Information</strong> - NO</li>
                        </ul>
                        <p>
                        ...
                        <p>
                            To exercise these rights, you can contact us by visiting <a href="mailto:contact@furlab.cc">contact@furlab.cc</a>, by emailing us at <a href="mailto:contact@furlab.cc">contact@furlab.cc</a>, or by referring to the contact details at the bottom of this document.
                        </p>
                        <p>
                        ...
                        <p>
                            Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:contact@furlab.cc">contact@furlab.cc</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.
                        </p>
                        <p>
                        ...
                        <p>
                            Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please visit: <a href="mailto:contact@furlab.cc">contact@furlab.cc</a>.
                        </p>
                    </div>
                </div>
            </div>
